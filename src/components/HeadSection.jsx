    ...
    return (
        <header id="HomeSection">
            <div className="header-content--primary">
                ...
                >
                    <motion.div className="primaryHeaderBoxAnimation"
                        variants={headerBox}
                        initial="initX"
            ...
            <div className="header-content--secondary">
                ...
                >
                    ...
                    <div className='header-content__projectCounter'> {`${projectCounter}`} </div>
                    <motion.div className='header-content__projectCounterContainer--Animation'
                        // Check hover prior to animation
